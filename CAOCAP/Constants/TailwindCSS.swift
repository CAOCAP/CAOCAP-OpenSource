...
struct TailwindCSS {
    ...
    static let all: [ClassNameTuple] = [
        (name: .tailwind(.aspectRatio), array: aspectRatio),
        (name: .tailwind(.container), array: container),
        (name: .tailwind(.columns), array: columns),
        (name: .tailwind(.breakAfter), array: breakAfter),
        (name: .tailwind(.breakBefore), array: breakBefore),
        (name: .tailwind(.breakInside), array: breakInside),
        (name: .tailwind(.boxDecorationBreak), array: boxDecorationBreak),
        (name: .tailwind(.boxSizing), array: boxSizing),
        (name: .tailwind(.display), array: display),
        (name: .tailwind(.floats), array: floats),
        (name: .tailwind(.clear), array: clear),
        (name: .tailwind(.isolation), array: isolation),
        (name: .tailwind(.objectFit), array: objectFit),
        (name: .tailwind(.objectPosition), array: objectPosition),
        (name: .tailwind(.overflow), array: overflow),
        (name: .tailwind(.overscrollBehavior), array: overscrollBehavior),
        (name: .tailwind(.position), array: position),
        (name: .tailwind(.topRightBottomLeft), array: topRightBottomLeft),
        (name: .tailwind(.visibility), array: visibility),
        (name: .tailwind(.zIndex), array: zIndex),
        (name: .tailwind(.flexBasis), array: flexBasis),
        (name: .tailwind(.flexDirection), array: flexDirection),
        (name: .tailwind(.flexWrap), array: flexWrap),
        (name: .tailwind(.flex), array: flex),
        (name: .tailwind(.flexGrow), array: flexGrow),
        (name: .tailwind(.flexShrink), array: flexShrink),
        (name: .tailwind(.order), array: order),
        (name: .tailwind(.gridTemplateColumns), array: gridTemplateColumns),
        (name: .tailwind(.gridColumnStartEnd), array: gridColumnStartEnd),
        (name: .tailwind(.gridTemplateRows), array: gridTemplateRows),
        (name: .tailwind(.gridRowStartEnd), array: gridRowStartEnd),
        (name: .tailwind(.gridAutoFlow), array: gridAutoFlow),
        (name: .tailwind(.gridAutoColumns), array: gridAutoColumns),
        (name: .tailwind(.gridAutoRows), array: gridAutoRows),
        (name: .tailwind(.gap), array: gap),
        (name: .tailwind(.justifyContent), array: justifyContent),
        (name: .tailwind(.justifyItems), array: justifyItems),
        (name: .tailwind(.justifySelf), array: justifySelf),
        (name: .tailwind(.alignContent), array: alignContent),
        (name: .tailwind(.alignItems), array: alignItems),
        (name: .tailwind(.alignSelf), array: alignSelf),
        (name: .tailwind(.placeContent), array: placeContent),
        (name: .tailwind(.placeItems), array: placeItems),
        (name: .tailwind(.placeSelf), array: placeSelf),
        (name: .tailwind(.padding), array: padding),
        (name: .tailwind(.margin), array: margin),
        (name: .tailwind(.spaceBetween), array: spaceBetween),
        (name: .tailwind(.width), array: width),
        (name: .tailwind(.minWidth), array: minWidth),
        (name: .tailwind(.maxWidth), array: maxWidth),
        (name: .tailwind(.height), array: height),
        (name: .tailwind(.minHeight), array: minHeight),
        (name: .tailwind(.maxHeight), array: maxHeight),
        (name: .tailwind(.fontFamily), array: fontFamily),
        (name: .tailwind(.fontSize), array: fontSize),
        (name: .tailwind(.fontSmoothing), array: fontSmoothing),
        (name: .tailwind(.fontStyle), array: fontStyle),
        (name: .tailwind(.fontWeight), array: fontWeight),
        (name: .tailwind(.fontVariantNumeric), array: fontVariantNumeric),
        (name: .tailwind(.letterSpacing), array: letterSpacing),
        (name: .tailwind(.lineClamp), array: lineClamp),
        (name: .tailwind(.lineHeight), array: lineHeight),
        (name: .tailwind(.listStyleImage), array: listStyleImage),
        (name: .tailwind(.listStylePosition), array: listStylePosition),
        (name: .tailwind(.listStyleType), array: listStyleType),
        (name: .tailwind(.textAlign), array: textAlign),
        (name: .tailwind(.textColor), array: textColor),
        (name: .tailwind(.textDecoration), array: textDecoration),
        (name: .tailwind(.textDecorationColor), array: textDecorationColor),
        (name: .tailwind(.textDecorationStyle), array: textDecorationStyle),
        (name: .tailwind(.textDecorationThickness), array: textDecorationThickness),
        (name: .tailwind(.textUnderlineOffset), array: textUnderlineOffset),
        (name: .tailwind(.textTransform), array: textTransform),
        (name: .tailwind(.textOverflow), array: textOverflow),
        (name: .tailwind(.textIndent), array: textIndent),
        (name: .tailwind(.verticalAlign), array: verticalAlign),
        (name: .tailwind(.whitespace), array: whitespace),
        (name: .tailwind(.wordBreak), array: wordBreak),
        (name: .tailwind(.hyphens), array: hyphens),
        (name: .tailwind(.content), array: content),
        (name: .tailwind(.backgroundAttachment), array: backgroundAttachment),
        (name: .tailwind(.backgroundClip), array: backgroundClip),
        (name: .tailwind(.backgroundColor), array: backgroundColor),
        (name: .tailwind(.backgroundOrigin), array: backgroundOrigin),
        (name: .tailwind(.backgroundPosition), array: backgroundPosition),
        (name: .tailwind(.backgroundRepeat), array: backgroundRepeat),
        (name: .tailwind(.backgroundSize), array: backgroundSize),
        (name: .tailwind(.backgroundImage), array: backgroundImage),
        (name: .tailwind(.gradientColorStops), array: gradientColorStops),
        (name: .tailwind(.borderRadius), array: borderRadius),
        (name: .tailwind(.borderWidth), array: borderWidth),
        (name: .tailwind(.borderColor), array: borderColor),
        (name: .tailwind(.borderStyle), array: borderStyle),
        (name: .tailwind(.divideWidth), array: divideWidth),
        (name: .tailwind(.divideColor), array: divideColor),
        (name: .tailwind(.divideStyle), array: divideStyle),
        (name: .tailwind(.outlineWidth), array: outlineWidth),
        (name: .tailwind(.outlineColor), array: outlineColor),
        (name: .tailwind(.outlineStyle), array: outlineStyle),
        (name: .tailwind(.outlineOffset), array: outlineOffset),
        (name: .tailwind(.ringWidth), array: ringWidth),
        (name: .tailwind(.ringColor), array: ringColor),
        (name: .tailwind(.ringOffsetWidth), array: ringOffsetWidth),
        (name: .tailwind(.ringOffsetColor), array: ringOffsetColor),
        (name: .tailwind(.boxShadow), array: boxShadow),
        (name: .tailwind(.boxShadowColor), array: boxShadowColor),
        (name: .tailwind(.opacity), array: opacity),
        (name: .tailwind(.mixBlendMode), array: mixBlendMode),
        (name: .tailwind(.backgroundBlendMode), array: backgroundBlendMode),
        (name: .tailwind(.blur), array: blur),
        (name: .tailwind(.brightness), array: brightness),
        (name: .tailwind(.contrast), array: contrast),
        (name: .tailwind(.dropShadow), array: dropShadow),
        (name: .tailwind(.grayscale), array: grayscale),
        (name: .tailwind(.hueRotate), array: hueRotate),
        (name: .tailwind(.invert), array: invert),
        (name: .tailwind(.saturate), array: saturate),
        (name: .tailwind(.sepia), array: sepia),
        (name: .tailwind(.backdropBlur), array: backdropBlur),
        (name: .tailwind(.backdropBrightness), array: backdropBrightness),
        (name: .tailwind(.backdropContrast), array: backdropContrast),
        (name: .tailwind(.backdropGrayscale), array: backdropGrayscale),
        (name: .tailwind(.backdropHueRotate), array: backdropHueRotate),
        (name: .tailwind(.backdropInvert), array: backdropInvert),
        (name: .tailwind(.backdropOpacity), array: backdropOpacity),
        (name: .tailwind(.backdropSaturate), array: backdropSaturate),
        (name: .tailwind(.backdropSepia), array: backdropSepia),
        (name: .tailwind(.borderCollapse), array: borderCollapse),
        (name: .tailwind(.borderSpacing), array: borderSpacing),
        (name: .tailwind(.tableLayout), array: tableLayout),
        (name: .tailwind(.captionSide), array: captionSide),
        (name: .tailwind(.transitionProperty), array: transitionProperty),
        (name: .tailwind(.transitionDuration), array: transitionDuration),
        (name: .tailwind(.transitionTimingFunction), array: transitionTimingFunction),
        (name: .tailwind(.transitionDelay), array: transitionDelay),
        (name: .tailwind(.animation), array: animation),
        (name: .tailwind(.scale), array: scale),
        (name: .tailwind(.rotate), array: rotate),
        (name: .tailwind(.translate), array: translate),
        (name: .tailwind(.skew), array: skew),
        (name: .tailwind(.transformOrigin), array: transformOrigin),
        (name: .tailwind(.accentColor), array: accentColor),
        (name: .tailwind(.appearance), array: appearance),
        (name: .tailwind(.cursor), array: cursor),
        (name: .tailwind(.caretColor), array: caretColor),
        (name: .tailwind(.pointerEvents), array: pointerEvents),
        (name: .tailwind(.resize), array: resize),
        (name: .tailwind(.scrollBehavior), array: scrollBehavior),
        (name: .tailwind(.scrollMargin), array: scrollMargin),
        (name: .tailwind(.scrollPadding), array: scrollPadding),
        (name: .tailwind(.scrollSnapAlign), array: scrollSnapAlign),
        (name: .tailwind(.scrollSnapStop), array: scrollSnapStop),
        (name: .tailwind(.scrollSnapType), array: scrollSnapType),
        (name: .tailwind(.touchAction), array: touchAction),
        (name: .tailwind(.userSelect), array: userSelect),
        (name: .tailwind(.willChange), array: willChange),
        (name: .tailwind(.fill), array: fill),
        (name: .tailwind(.stroke), array: stroke),
        (name: .tailwind(.strokeWidth), array: strokeWidth),
        (name: .tailwind(.screenReaders), array: screenReaders)
    ]
